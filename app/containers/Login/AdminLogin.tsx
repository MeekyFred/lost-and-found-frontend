...
import { adminLogin as adminLoginAPI } from "@/app/services/auth.service";
...
function AdminLogin() {
  ...
  async function handleSubmit(data: any) {
    ...
    try {
      const payload = { data };
      const { accessToken, refreshToken } = await adminLogin(payload);
  ...
  return (
    <div className="app__admin-login">
